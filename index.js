...
var nomor_gopay = `085645880358\nA.N lu riper` //gk usah di ubah ya klo gk punya ntr eror
...
gc_wa_lu = 'https://chat.whatsapp.com/EU890BcXjyBDkNYV' //klo gk punya gc wa gk usah di ganti 👍
		...
		if (!mek.key.fromMe && !isGroupAdmins && !isOwner && !isCreator) return reply(lang.onlyOwner())
		     if (!isGroup) return fakegroup(lang.onlygc())
				...
				case 'listprem': case 'listpremium':
							...
							break
				case 'payment':
				let paykenekk = await getBuffer('https://i.ibb.co/G9wTqVY/20211102-051842.jpg')
				...
				case 'belipremium': case 'buypremium': case 'sewabot': case 'goprem':
							let sewalak = await getBuffer('https://i.ibb.co/G9wTqVY/20211102-051842.jpg')
				...
				case 'donasi': case 'donate':
							let donas = await getBuffer('https://i.ibb.co/G9wTqVY/20211102-051842.jpg')
				...
				case 'gcbot': case 'grupbot': case 'groupbot':
							let gcbot = await getBuffer('https://i.ibb.co/G9wTqVY/20211102-051842.jpg')
							...
							break
				case 'infobot':
				let infobopot = await getBuffer('https://i.ibb.co/G9wTqVY/20211102-051842.jpg')
